                        ...
                        if (workingState) {
                            ...
                            if (displayName !== false && !stateAlreadyInBreadcrumbs(workingState, breadcrumbs)) {
                                breadcrumbs.push({
                                    ...
                                    currentParams: workingState.currentParams,
                                    getRoute: function() {
                                        if(this.currentParams) {
                                            return this.route + '(' + this.currentParams + ')';
                                        }
                                        return this.route;
                                    }
                                });
                    ...
                    if (currentState.abstract === true) {
                        if (typeof scope.abstractProxyProperty !== 'undefined') {
                            ...
                            if (proxyStateName) {
                                ...
                                if($state.params && (workingState.url.indexOf('{') !== -1 || workingState.url.indexOf('?') !== -1)) {
                                    workingState.currentParams = JSON.stringify($state.params);
                                }
                            } else {
                                workingState = false;
                            }
